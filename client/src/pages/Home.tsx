    ...
    <div className="bg-environmental-protection bg-cover bg-center min-h-svh z-0">
      <div className="bg-base-100 bg-opacity-80 min-h-svh p-8 z-1 ">
        <div className="flex flex-col lg:flex-row z-2 mt-8">
          <div className="lg:basis-1/6 grow text-base-100-content p-6 rounded text-center m-2 flex flex-col justify-between">
          ...
          <div className="lg:basis-1/2 text-base-100-content p-6 text-center m-2 lg:mt-20 ">
          ...
          <div className="lg:basis-1/6 grow text-base-100-content p-6 rounded text-center m-2 flex justify-between flex-col">
